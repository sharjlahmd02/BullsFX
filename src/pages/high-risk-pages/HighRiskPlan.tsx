...
const HighRiskPlans = ({ isDark }: { isDark: boolean }) => {
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          <div>
            <h1 className="text-5xl font-bold leading-tight">
              High-Risk
              <span className="text-[#08CB00]"> Reward Plans</span>
            </h1>
            <p className="mt-6 text-lg opacity-70 max-w-xl">
              Aggressive trading strategies designed for investors seeking
              maximum monthly returns with higher market exposure.
            </p>
          </div>
        ...
        <div className="space-y-10">
          {highRiskPlans.map((plan) => {
            ...
            return (
              <div
                key={plan.id}
                onClick={() => navigate(`/high-risk/${plan.id}`)}
